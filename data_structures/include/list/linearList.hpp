...
class LinearList : public List<T> {
  ...
  public:
	...
	LinearList<T>& operator+=(const LinearList<T>& list2) {
	...
	LinearList<T>& operator-=(const LinearList<T>& list2) {
		...
		LinearList<T> result(this->maxSize);
	...
	LinearList<T> operator-(const LinearList<T>& list2) {
		...
		std::unordered_set<T> set;
		LinearList<T> result(this->_size);
	...
	LinearList<T> operator-(const LinearList<T>& list2) const {
