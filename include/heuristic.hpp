...
inline int aptedRec(const Graph& T1, const Graph& T2, int u, int v,
                    const std::vector<std::vector<int>>& ch1,
                    const std::vector<std::vector<int>>& ch2,
                    const std::vector<int>& sz1,
